...
- **Bußgelder** nach **Artikel 83** kommen in zwei Stufen, maßgeblich ist jeweils der höhere Betrag: **10 000 000 Euro oder 2 Prozent** des gesamten weltweit erzielten Jahresumsatzes für die Pflichten von Verantwortlichem und Auftragsverarbeiter (Art. 83(4)) und **20 000 000 Euro oder 4 Prozent** für Verstöße gegen die Grundsätze, die Einwilligungsbedingungen und die Rechte der betroffenen Personen (Art. 83(5)). **Artikel 84** überlässt die übrigen Sanktionen dem nationalen Recht, **Artikel 82** ergänzt einen privatrechtlichen Schadensersatzanspruch. Die Angabe der Kursfolie von 2 Millionen Euro ist falsch, zitiert werden sollte der Artikel.
