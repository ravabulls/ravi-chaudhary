...
<figure class="sc-fig">
  <div class="sc-flow col">
    <div class="sc-panel" style="text-align:center;max-width:28rem">
      <div class="head" style="border:0;color:var(--sc-blue)">Industrie 4.0 — der Kernwandel</div>
      Digitalisierung (Verschmelzung vertikaler &amp; horizontaler Wertschöpfungsketten) · digitalisierte Geschäftsstrategien &amp; Kundenreichweite · Produkte &amp; Dienstleistungen werden digital
    </div>
    <span class="arrow">↓ &nbsp;getragen von den 9 Säulen</span>
    <div class="sc-chips">
      <span class="sc-chip">Autonome Roboter</span>
      <span class="sc-chip">Additive Fertigung</span>
      <span class="sc-chip">IIoT-Plattformen</span>
      <span class="sc-chip">Cloud Computing</span>
      <span class="sc-chip">Horizontale &amp; vertikale Systemintegration</span>
      <span class="sc-chip">Cybersicherheit</span>
      <span class="sc-chip">Big Data &amp; Analytik</span>
      <span class="sc-chip">Simulation</span>
      <span class="sc-chip">Augmented Reality</span>
    </div>
  </div>
  <figcaption>Die neun Säulen (Technologie-Enabler) von Industrie 4.0, die den digitalen Kernwandel von Wertschöpfungsketten, Geschäftsstrategie und Produkten umgeben und antreiben.</figcaption>
</figure>
