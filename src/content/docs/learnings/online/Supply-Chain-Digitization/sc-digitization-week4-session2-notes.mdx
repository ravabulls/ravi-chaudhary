...
<figure class="sc-fig">
  <div class="sc-flow col">
    <div class="sc-chips">
      <span class="sc-chip">End Customer 1</span>
      <span class="sc-chip">End Customer 2</span>
      <span class="sc-chip amber">Transport Provider 1</span>
      <span class="sc-chip amber">Transport Provider 2</span>
      <span class="sc-chip green">Seller 1</span>
      <span class="sc-chip green">Seller 2</span>
      <span class="sc-chip violet">Financial Institution</span>
      <span class="sc-chip violet">Others</span>
    </div>
    <span class="arrow">↓ &nbsp;all connect to</span>
    <div class="sc-node">E-commerce website<span class="sub">multi-sided platform (MSP)</span></div>
  </div>
  <figcaption>The platform economy - the e-commerce website acts as a multi-sided platform that serves many players at once: customers, sellers, logistics providers, financial institutions and others all transact through the central hub.</figcaption>
</figure>
