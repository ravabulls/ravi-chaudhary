...
<figure class="sc-fig">
  <div class="sc-flow">
    <div class="sc-tier"><div class="sc-tier-head">Material suppliers</div><div class="sc-node violet">Supplier</div><div class="sc-node violet">Supplier</div><div class="sc-node violet">Supplier</div></div>
    <span class="arrow">→</span>
    <div class="sc-tier"><div class="sc-tier-head">Factories</div><div class="sc-node">Factory</div><div class="sc-node">Factory</div><div class="sc-node">Factory</div></div>
    <span class="arrow">→</span>
    <div class="sc-tier"><div class="sc-tier-head">Warehouses (per market)</div><div class="sc-node slate">Market 1 W/H</div><div class="sc-node slate">Market 2 W/H</div></div>
    <span class="arrow">→</span>
    <div class="sc-tier"><div class="sc-tier-head">Retailers</div><div class="sc-node soft">Many retailers per market</div></div>
  </div>
  <figcaption>Why tracking &amp; traceability matters - as goods flow from material suppliers through factories and market warehouses to many retailers, every hand-off is a point that must be recorded to trace any product end-to-end.</figcaption>
</figure>
