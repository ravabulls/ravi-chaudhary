...
<figure class="sc-fig">
  <div class="sc-flow col">
    <div class="sc-panel" style="text-align:center;max-width:28rem">
      <div class="head" style="border:0;color:var(--sc-blue)">Industry 4.0 — the core shift</div>
      Digitisation (merging vertical &amp; horizontal value chains) · digitalised business strategies &amp; customer reach · products &amp; services going digital
    </div>
    <span class="arrow">↓ &nbsp;enabled by the 9 pillars</span>
    <div class="sc-chips">
      <span class="sc-chip">Autonomous Robots</span>
      <span class="sc-chip">Additive Manufacturing</span>
      <span class="sc-chip">IIoT Platforms</span>
      <span class="sc-chip">Cloud Computing</span>
      <span class="sc-chip">Horizontal &amp; Vertical System Integration</span>
      <span class="sc-chip">Cybersecurity</span>
      <span class="sc-chip">Big Data &amp; Analytics</span>
      <span class="sc-chip">Simulation</span>
      <span class="sc-chip">Augmented Reality</span>
    </div>
  </div>
  <figcaption>The nine pillars (or technology enablers) of Industry 4.0 that surround and drive the core digital transformation of value chains, business strategy, and products.</figcaption>
</figure>
