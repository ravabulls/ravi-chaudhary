...
*Which Industry 4.0 technologies apply to each supply-chain process (✓ = applicable):*

| Process ↓ / Tech → | AI | Big Data | IoT | Cloud | Digital Twins | Robotics | AR-VR | Blockchain | Additive Mfg | Simulation | Cyber Security | System Integ. |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
