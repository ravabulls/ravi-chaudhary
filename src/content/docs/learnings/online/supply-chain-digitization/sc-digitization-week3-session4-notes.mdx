...
<figure class="sc-fig">
  ...
  <div class="sc-quad">
    <div class="q amber"><div class="qh">Bottleneck items</div><ul><li>High supply risk · low profit impact</li></ul></div>
    <div class="q violet"><div class="qh">Strategic items</div><ul><li>High supply risk · high profit impact</li></ul></div>
    <div class="q blue"><div class="qh">Non-critical items</div><ul><li>Low supply risk · low profit impact</li></ul></div>
    <div class="q green"><div class="qh">Leverage items</div><ul><li>Low supply risk · high profit impact</li></ul></div>
  </div>
  <div class="sc-axis">Low profit impact ← → High profit impact &nbsp;·&nbsp; ↓ Low supply risk</div>
  <figcaption>The Kraljic matrix - supply risk (y-axis) against profit impact (x-axis) - sorts every purchased item into one of four quadrants, each with its own sourcing strategy.</figcaption>
</figure>
