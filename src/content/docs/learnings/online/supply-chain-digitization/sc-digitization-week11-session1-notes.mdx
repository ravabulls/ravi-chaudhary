...
<figure class="sc-fig">
  <div class="sc-flow">
    ...
    <span class="arrow">→</span>
    <div class="sc-tier"><div class="sc-tier-head">Markets</div><div class="sc-node violet">Mumbai</div><div class="sc-node violet">Pune</div><div class="sc-node violet">Surat</div><div class="sc-node violet">Ahmedabad</div></div>
  </div>
  <figcaption>The western-India supply network - two candidate factories (Aurangabad, Nashik) feed two candidate DCs (Bhiwandi, Vapi), which serve four markets. Every arrow is a possible route the optimisation can switch on or off.</figcaption>
</figure>
...
<Aside type="note">
The same network plotted on a real map (via a GIS / mapping tool) - the factories, DCs and markets across Gujarat and Maharashtra with the physical road routes between them. This geographic "digital visualisation" of the physical supply chain is the view that sits behind the abstract network diagram above.
</Aside>
