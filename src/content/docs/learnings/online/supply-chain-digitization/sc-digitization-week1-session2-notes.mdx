  ...
  <table class="sc-matrix">
    <thead>
      <tr>
        ...
        <th>Very low volume, unique</th>
        <th>Low volume, unique product</th>
        <th>Low volume, multiple products</th>
        <th>High volume, standardised</th>
        <th>Very high volume, commodity</th>
      </tr>
    </thead>
    <tbody>
      <tr><th>Project (fixed position)</th><td class="hl">Project</td><td></td><td></td><td></td><td></td></tr>
      <tr><th>Jumbled flow</th><td></td><td class="hl">Job Shop</td><td></td><td></td><td></td></tr>
      <tr><th>Disconnected line flow</th><td></td><td></td><td class="hl">Batch</td><td></td><td></td></tr>
      <tr><th>Connected line flow</th><td></td><td></td><td></td><td class="hl">Assembly-line</td><td></td></tr>
      <tr><th>Continuous flow</th><td></td><td></td><td></td><td></td><td class="hl">Continuous</td></tr>
    </tbody>
  </table>
  <figcaption>The product-process matrix: viable operations sit on the diagonal. As <b>volume rises and variety falls</b> (top-left → bottom-right), the fitting process shifts Project → Job Shop → Batch → Assembly-line → Continuous.</figcaption>
</figure>
