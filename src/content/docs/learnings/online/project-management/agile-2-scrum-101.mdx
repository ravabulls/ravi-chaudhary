...
*Next: [Implementing Scrum →](/learnings/online/project-management/agile-3-implementing-scrum/) - the backlog, estimation, the five Scrum events, and the tools that track a Sprint.*
