					...
					items: [
						{
							...
							items: [
								...
								{
									label: 'Innovation & New Business Planning', translations: { de: 'Innovation & neue Geschäftsplanung' },
									collapsed: true,
									items: [
										{ label: 'Overview', link: 'learnings/mba/innovation-and-new-business-planning', translations: { de: 'Übersicht' } },
										{ label: '1 · Adoption & Diffusion', link: 'learnings/mba/innovation-and-new-business-planning/01-adoption-and-diffusion', translations: { de: '1 · Adoption & Diffusion' } },
										{ label: '2 · Recipients', link: 'learnings/mba/innovation-and-new-business-planning/02-communication-recipients', translations: { de: '2 · Empfänger' } },
										{ label: '3 · Objectives & Messages', link: 'learnings/mba/innovation-and-new-business-planning/03-communication-objectives-and-messages', translations: { de: '3 · Ziele & Botschaften' } },
										{ label: '4 · Channels & KPIs', link: 'learnings/mba/innovation-and-new-business-planning/04-communication-channels-and-kpis', translations: { de: '4 · Kanäle & KPIs' } },
										{ label: '5 · Digital: Outbound', link: 'learnings/mba/innovation-and-new-business-planning/05-digital-marketing-outbound', translations: { de: '5 · Digital: Outbound' } },
										{ label: '6 · Digital: Inbound & Social', link: 'learnings/mba/innovation-and-new-business-planning/06-digital-marketing-inbound-social-mobile', translations: { de: '6 · Digital: Inbound & Social' } },
										{ label: '7 · Pricing Basics', link: 'learnings/mba/innovation-and-new-business-planning/07-pricing-basics', translations: { de: '7 · Preis-Grundlagen' } },
										{ label: '8 · Dynamic Pricing', link: 'learnings/mba/innovation-and-new-business-planning/08-dynamic-pricing-and-differentiation', translations: { de: '8 · Dynamische Preise' } },
										{ label: '9 · Value-Based Pricing', link: 'learnings/mba/innovation-and-new-business-planning/09-value-based-pricing', translations: { de: '9 · Wertbasierte Preise' } },
										{ label: '10 · Sales & Channels', link: 'learnings/mba/innovation-and-new-business-planning/10-sales-and-channel-management', translations: { de: '10 · Vertrieb & Kanäle' } },
										{ label: '11 · Financial Planning', link: 'learnings/mba/innovation-and-new-business-planning/11-financial-planning-and-projections', translations: { de: '11 · Finanzplanung' } },
										{ label: '12 · Ownership & Returns', link: 'learnings/mba/innovation-and-new-business-planning/12-ownership-dilution-and-returns', translations: { de: '12 · Anteile & Renditen' } },
										{ label: '13 · Valuation Methods', link: 'learnings/mba/innovation-and-new-business-planning/13-valuation-methods', translations: { de: '13 · Bewertungsmethoden' } },
										{ label: '14 · Term Sheets', link: 'learnings/mba/innovation-and-new-business-planning/14-term-sheets', translations: { de: '14 · Term Sheets' } },
										{ label: '15 · Staged Financing', link: 'learnings/mba/innovation-and-new-business-planning/15-staged-financing-and-down-rounds', translations: { de: '15 · Stufenfinanzierung' } },
									],
								},
								{
									label: 'Legal Aspects of Technology Management', translations: { de: 'Rechtliche Aspekte des Technologiemanagements' },
									collapsed: true,
									items: [
										{ label: 'Overview', link: 'learnings/mba/legal-aspects-of-technology-management', translations: { de: 'Übersicht' } },
										{ label: '1 · What Law Is', link: 'learnings/mba/legal-aspects-of-technology-management/01-what-law-is', translations: { de: '1 · Was Recht ist' } },
										{ label: '2 · Contract Law', link: 'learnings/mba/legal-aspects-of-technology-management/02-contract-law', translations: { de: '2 · Vertragsrecht' } },
										{ label: '3 · Cross-Border Trade', link: 'learnings/mba/legal-aspects-of-technology-management/03-cross-border-trade', translations: { de: '3 · Grenzüberschreitender Handel' } },
										{ label: '4 · Data Protection Foundations', link: 'learnings/mba/legal-aspects-of-technology-management/04-data-protection-foundations', translations: { de: '4 · Datenschutz-Grundlagen' } },
										{ label: '5 · Breaches & IT Security', link: 'learnings/mba/legal-aspects-of-technology-management/05-breaches-documentation-and-it-security', translations: { de: '5 · Datenpannen & IT-Sicherheit' } },
										{ label: '6 · Liability & Transfers', link: 'learnings/mba/legal-aspects-of-technology-management/06-liability-and-international-transfers', translations: { de: '6 · Haftung & Datenübermittlung' } },
										{ label: '7 · Trade Secrets & NDAs', link: 'learnings/mba/legal-aspects-of-technology-management/07-trade-secrets-and-ndas', translations: { de: '7 · Geschäftsgeheimnisse & NDAs' } },
										{ label: '8 · Cooperation & Cloud', link: 'learnings/mba/legal-aspects-of-technology-management/08-cooperation-and-cloud-agreements', translations: { de: '8 · Kooperation & Cloud' } },
										{ label: '9 · The IP System', link: 'learnings/mba/legal-aspects-of-technology-management/09-the-ip-system', translations: { de: '9 · Das IP-System' } },
										{ label: '10 · Patents', link: 'learnings/mba/legal-aspects-of-technology-management/10-patents', translations: { de: '10 · Patente' } },
										{ label: '11 · Trademarks & Copyright', link: 'learnings/mba/legal-aspects-of-technology-management/11-trademarks-designs-and-copyright', translations: { de: '11 · Marken & Urheberrecht' } },
										{ label: '12 · Communication & Negotiation', link: 'learnings/mba/legal-aspects-of-technology-management/12-communication-and-negotiation', translations: { de: '12 · Kommunikation & Verhandlung' } },
										{ label: '13 · Law on AI', link: 'learnings/mba/legal-aspects-of-technology-management/13-law-on-artificial-intelligence', translations: { de: '13 · Recht der KI' } },
									],
								},
							],
						},
								...
								items: [
									...
									},
									{
										...
										items: [
											...
											{ label: '4 · Leadership & Influence', translations: { de: '4 · Führung & Einfluss' }, link: 'learnings/online/project-management/execution-4-leadership' },
											{ label: '5 · Communication', translations: { de: '5 · Kommunikation' }, link: 'learnings/online/project-management/execution-5-communication' },
